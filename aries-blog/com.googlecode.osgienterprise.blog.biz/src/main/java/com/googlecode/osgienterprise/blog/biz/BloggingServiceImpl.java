...
import com.googlecode.osgienterprise.blog.api.BlogAuthorManager;
import com.googlecode.osgienterprise.blog.api.BlogComment;
import com.googlecode.osgienterprise.blog.api.BlogCommentManager;
...
public class BloggingServiceImpl implements BloggingService {
    ...
    public void init() {
        System.out.println(getNoOfEntries());
    }
